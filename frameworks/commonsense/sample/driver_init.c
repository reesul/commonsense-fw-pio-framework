...
struct spi_m_sync_descriptor SPI_MASTER;
...
void SPI_MASTER_init(void)
{
	...
	spi_m_sync_init(&SPI_MASTER, SERCOM4);
...
void system_init(void)
{
	...
	// Set pin direction to output
	gpio_set_pin_direction(CS_0_PIN, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(CS_0_PIN, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PB26

	gpio_set_pin_level(RED,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
